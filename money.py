...
from utils import get_inventory, get_equipped, get_item_count, add_item_to_inventory, remove_item_from_inventory, check_achievements, save_equipped, log_user_action
...
async def shop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        text += f"• Редуктор ({limits.get('редуктор', 50)}/50)\n"
        text += f"• Энергетик ({limits.get('энергетик', 100)}/100)\n\n"
